...
int main() {
    ...
    processImage("../bitmaps/image1.bmp", 0.0, 100, 200, "../outputs/grayscale/image1.csv", "../outputs/hough/image1.csv");
    ...
    //processImage("../bitmaps/rick_and_morty.bmp", 0.2, 100, 150, "../outputs/grayscale/rick_and_morty.csv", "../outputs/hough/rick_and_morty.csv");
